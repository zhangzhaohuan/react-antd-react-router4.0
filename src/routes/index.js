...
import AsyncComponent from '../components/asynccomponent/AsyncComponent';//按需加载路由组件
    ...
    render() {
        return (
            <Switch>
                ...
                <Route exact path="/app/form/basicForm" render={(props) => (
                    <AsyncComponent {...props} loader={import('../components/forms/BasicForm')} />)} />
